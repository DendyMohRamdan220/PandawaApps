...
class TicketController extends Controller
{
    ...
    return view('Tickets.datatiket_employee', compact('data'), [
    'totaltiket' => $totaltiket,
    'totalordertiket' => $totalordertiket,
    'totalprogrestiket' => $totalprogrestiket,
    'totalpendingtiket' => $totalpendingtiket,
    ...
    public function tambahtiket_employee()
    {
    return view('Tickets.tambahdatatiket_employee');
    }

    public function insertdatatiket_employee(Request $request)
    {
    Ticket::create($request->all());
    return redirect('/ticket_employee')->with('success', 'tickets added successfully .');
    }

    public function tampildatatiket_employee($id)
    {
    $data = Ticket::find($id);
    return view('Tickets.tampildatatiket_employee', compact('data'));
    }
    ...
    $data = Ticket::find($id);
    $data->update($request->all());
    return redirect('/ticket_employee')->with('success', 'tickets edited successfully .');
    }

    public function deleteticket_employee($id)
    {
    $data = Ticket::find($id);
    $data->delete();
    return redirect('/ticket_employee')->with('success', 'tickets deleted successfully .');
    }
}
