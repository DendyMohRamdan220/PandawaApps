        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header row">
                    <div class="col-auto">
                        <a href="/tambahdatasales_admin" class="btn btn-success">
                            <i class="nav-icon icon-plus"></i> Add Sales</a>
                    </div>
                    <div class="col-auto">
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            @php
                                $no = 1;
                            @endphp
                            @foreach ($data as $datauser_sales => $row)
                                @if ($row->level == 'Sales')
                                    <tr>
                                        <th scope="row">{{ $no++ }}</th>
                                        <td>{{ $row->name }}</td>
                                    ...
                                    <td>
                                        <a class="btn btn-info" href="/editdatasales_admin/{{ $row->id }}">
...
<script>
    $('.delete').click(function() {
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    window.location = "/deletedatasales_admin/" + clientid + ""
