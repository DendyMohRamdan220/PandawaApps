    ...
    <div class="page-body">
        <div class="col-sm-6">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="/datasales_admin"> Sales </a></li>
        ...
        <div class="row justify-content-center">
            <div class="col-9">
                <div class="card">
                    <div class="card-body">
                        <form method="POST" action="/updatedatasales_admin/{{ $data->id }}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input class="form-control @error('password') is-invalid @enderror" type="password"
                                        name="password" id="pass" palaceholder="********">
                            ...
                            <div class="form-group">
                                ...
                                <input name="address" type="text"
                                    class="form-control @error('address') is-invalid @enderror" id="exampleInputCity2"
                            ...
                            <div class="form-group">
                                ...
                                <input name="mobile" type="Tel"
                                    class="form-control @error('mobile') is-invalid @enderror" id="exampleInputCity2"
                                    placeholder="Enter your mobile phone" value="{{ $data->mobile }}">
                                @error('mobile')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="card-footer text-end">
                                ...
                                <a href="/datasales_admin"class="btn btn-light">Cancel</a>
                            </div>
                        </form>
                    </div>
                </div>
