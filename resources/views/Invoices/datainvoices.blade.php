        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header row">
                    <div class="col-auto">
                        <a href="/tambahdatainvoices_admin" class="btn btn-success"> <i class="nav-icon icon-plus">
                            </i> Add Invoice </a>
                    </div>
                    <div class="col-auto">
                        ...
                        <tbody>
                            ...
                            @foreach ($data as $datainvoices_admin => $row)
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-info" href="/editdatainvoices_admin/{{ $row->id }}">
    ...
    <script>
        $('.delete').click(function() {
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        window.location = "/deletedatainvoices_admin/" + invoiceid + ""
