        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header row">
                    <div class="col-auto">
                        <a href="/tambahdataestimate_sales" class="btn btn-success">
                            <i class="nav-icon icon-plus"></i> Add Estimate </a>
                    </div>
                    <div class="col-auto">
                    ...
                    <div class="col-auto">
                        <a href="/exportpdfestimate_sales" class="btn btn-info">
                    ...
                    <table class="table table-striped bg-primary">
                        ...
                        <tbody>
                            @php
                                $no = 1;
                            @endphp
                            @foreach ($data as $dataestimate_sales => $row)
                                <tr>
                                    <th scope="row">{{ $dataestimate_sales + $data->firstItem() }}</th>
                                    <td>{{ $row->user->name }}</td>
    ...
    <script>
        $('.delete').click(function() {
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        window.location = "/deletedataestimate_sales/" + estimateid + ""
