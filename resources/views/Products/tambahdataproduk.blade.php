            ...
            <div class="row p-20">
                <div class="col-lg-4 col-md-6">
                    <div class="form-group my-3">
                        <label class="f-14 text-dark-grey mb-12" data-label="true" for="produk_name">Name<sup class="f-14 mr-1">*</sup></label>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="form-group my-3">
                        ...
                        <input type="text" class="form-control height-35 f-14" value="" name="produk_harga" id="produk_harga" autocomplete="off">
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <label class="f-14 text-dark-grey mb-12 mt-3" data-label="" for="produk_kategori">Product Category</label>
                    <div class="form-group mb-0">
                        <select name="produk_kategori" id="produk_kategori" class="form-control select-picker" data-size="8">
                            <option value="">--</option>
                ...
                <div class="col-lg-4 col-md-6">
                    <label class="f-14 text-dark-grey mb-12 mt-3" data-label="" for="status">Product Sub-Category</label>
                    <div class="form-group mb-0">
