            ...
            <div class="row">
                 ...
                 <div class="col-md-5 mb-3">
                  <select class="form-select" name="currency_from" required>
                    ...
                    <option value="IDR" {{ Request::get('currency_from') == 'IDR'?'selected':'' }}>Indonesia Rupiah</option>
               ...
               <div class="col-md-5 mb-3">
                    ...
                    <option value="">Select Currency</option>
                    <option value="IDR" {{ Request::get('currency_to') == 'IDR'?'selected':'' }}>Indonesia Rupiah</option>
