        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header row">
                    <div class="col-auto">
                        <a href="/tambahdataproposal_sales" class="btn btn-success">
                            <i class="nav-icon icon-plus"></i>Add Proposal</a>
                    </div>
                    <div class="col-auto">
                        <form action="/dataproposal_sales" method="GET">
                            <input type="search" id="inputPassword6" name="search" class="form-control"
                                aria-describedby="passwordHelpInline" placeholder="Search...">
                        </form>
                    </div>
                    <div class="col-auto">
                        <a href="/exportpdfproposal_sales" class="btn btn-info"> <i class="nav-icon fas fa-file-pdf">
                            </i> Export PDF</a>
                    </div>
                </div>
            </div>
    ...
    <script>
        $('.delete').click(function() {
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        window.location = "/deletedataproposal_sales/" + proposalid + ""
