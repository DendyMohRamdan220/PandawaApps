...
<body>
            ...
            <div class="container">
                <div class="error-page1">
                    <div class="svg-wrraper mb-0">
                        <svg class="svg-60" viewbox="0 0 1920 1080" xmlns="http://www.w3.org/2000/svg">
                            <g>
                                ...
                                <rect class="warning-color" height="8.39" rx="4.19" ry="4.19" width="513.38"
                                ...
                                <rect class="warning-color" height="8.39" rx="4.19" ry="4.19" width="249.8"
                                ...
                                <rect class="warning-color" height="8.39" rx="4.19" ry="4.19" width="54.72"
                                ...
                                <rect class="warning-color" height="8.39" rx="4.19" ry="4.19"
                                    width="78.11" x="997.06" y="981.47"></rect>
                                <g id="round-conf">
                            ...
                            <g id="fortyfour" data-name="Layer 2">
                                <g class="four a">
                                    <rect class="primary-color" height="466.29" rx="57.1" ry="57.1"
                                        ...
                                        y="391.14"></rect>
                                    <rect class="primary-color" height="396.88" rx="60.36" ry="60.36"
                                        width="120.71" x="333.83" y="475.1"></rect>
                                ...
                                <g class="four b">
                                    <rect class="primary-color" height="466.29" rx="57.1" ry="57.1"
                                        transform="translate(2244.26 -994.14) rotate(90)" width="120.71"
                                        x="1558.84" y="391.91"></rect>
                                    <rect class="primary-color" height="396.88" rx="60.36" ry="60.36"
                                        width="120.71" x="1658.92" y="475.87"></rect>
                                    <rect class="primary-color" height="604.75" rx="60.36" ry="60.36"
                                        transform="translate(530.57 -830.68) rotate(35)" width="120.71"
                                        x="1522.22" y="123.66"></rect>
                                </g>
                            ...
                            <g class="bicycle" data-name="Layer 5">
                                ...
                                <g>
                                    <rect class="warning-color" height="53.21"
                                        transform="translate(-165.97 273.38) rotate(-16.19)" width="12.87"
                                        x="871.39" y="693.37"></rect>
                                ...
                                <g>
                                    ...
                                    <circle class="secondary-color lighten-5" cx="1027.9" cy="587.94"
                                        r="12.99" transform="translate(-4.77 8.42) rotate(-0.47)"></circle>
                                </g>
                                <path class="secondary-color lighten-5"
                    ...
                    <div class="col-md-8 offset-md-2">
                        ...
                        <p class="sub-content">The page you are attempting to reach is currently not available. This
                            may be because the page does not exist or has been moved.</p>
                        @if (auth()->user()->level == 'Admin')
                            <a href="/dashboard_admin" class="btn btn-success"> BACK TO HOME PAGE </a>
                        @elseif (auth()->user()->level == 'Employee')
                           <a href="/dashboardv1" class="btn btn-success"> BACK TO HOME PAGE </a>
                        @elseif (auth()->user()->level == 'Client')
                           <a href="/dashboardv2" class="btn btn-success"> BACK TO HOME PAGE </a>
                        @elseif (auth()->user()->level == 'Sales')
                           <a href="/dashboardv3" class="btn btn-success"> BACK TO HOME PAGE </a>
                        @endif
                    </div>
                </div>
            </div>
    ...
    <script src="{{ asset('template/assets/js/config.js') }}/assets/js/config.js"></script>
    <!-- Bootstrap js-->
