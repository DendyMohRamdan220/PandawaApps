...
<<<<<<< HEAD
                    <div class="logo-wrapper"><a href="index.html"><img class="img-fluid"
                                src="{{ asset('template/assets/images/logopm.jpg') }}" alt=""></a></div>
...
>>>>>>> ce5d8919c6790ea9cfbdb9ade883ade84c27f4f5
                </div>
...
=======
                                    <li class="add-to-bookmark">
                                        <i class="bookmark-icon" data-feather="inbox">
                                        </i>Email<span class="pull-right">
                                            <i data-feather="star"></i>
                                        </span>
                                    </li>
                                    <li class="add-to-bookmark">
                                        <i class="bookmark-icon" data-feather="message-square">
                                        </i>Chat<span class="pull-right">
                                            <i data-feather="star"></i>
                                        </span>
                                    </li>
                                    <li class="add-to-bookmark">
                                        <i class="bookmark-icon" data-feather="command">
                                        </i>Feather Icon<span class="pull-right">
                                            <i data-feather="star"></i>
                                        </span>
                                    </li>
                                    <li class="add-to-bookmark"><i class="bookmark-icon" data-feather="airplay">
                                        </i>Widgets<span class="pull-right">
                                            <i data-feather="star"> </i>
                                        </span>
                                    </li>
>>>>>>> ce5d8919c6790ea9cfbdb9ade883ade84c27f4f5
...
=======
                            ...
                            <ul class="notification-dropdown onhover-show-div">
                                <li>
                                    <p class="f-w-700 mb-0">You have 3 Notifications
                            ...
                            <ul class="chat-dropdown onhover-show-div">
                                <li>
                                    <div class="media"><img class="img-fluid rounded-circle me-3"
                                            src="{{ asset('template/assets/images/user/4.jpg') }}" alt="">
                                ...
                                <li>
                                    <div class="media"><img class="img-fluid rounded-circle me-3"
                                            src="{{ asset('template/assets/images/user/1.jpg') }}" alt="">
                                ...
                                <li>
                                    <div class="media"><img class="img-fluid rounded-circle me-3"
                                            src="{{ asset('template/assets/images/user/2.jpg') }}" alt="">
...
<<<<<<< HEAD
                                            <li>
                                                <a href="/presensi_masuk">Absensi Masuk</a>
                                            </li>
                                            <li>
                                                <a href="/presensi_keluar">Absensi Keluar</a>
                                            </li>
=======
>>>>>>> ce5d8919c6790ea9cfbdb9ade883ade84c27f4f5
                                        </ul>
